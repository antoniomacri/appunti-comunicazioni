%
% Dopo aver compilato il documento con LATEX ed aver eseguito BibTEX, è necessario compilare
...
\usepackage{pst-pdf}
%\usepackage{pstricks-add}  % dà problemi perché non riesce a trovare \pstScalePoint
...
\usepackage{booktabs}
% il pacchetto seguente serve perché in alcuni casi (sperimentati) le note a margine compaiono nel margine sbagliato
\usepackage{mparhack}
%\usepackage{makeidx}
% Serve a eliminare le intestazioni delle pagine con contenuto vuoto (dopo ad esempio i capitoli)
% in modo che le pagine siano completamente vuote (anziché avere la sola inestetica intestazione):
...
\hypersetup{pdftitle={Appunti per il corso di Comunicazioni numeriche},%
            pdfsubject={Tratti dalle lezioni del prof. M. Martorella, Università di Pisa},%
            pdfauthor={Antonio Macrì ('Miro a Incanto'), Francesco Racciatti ('Strano Tic Cerca Fica')}}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Impostazioni generali

% La riga seguente deve precedere i comandi che ridefiniscono intestazioni e pié di pagina
...
% orizzontale e un po' di spazi verticali, siano emessi innumerevoli warning perché non stanno
...
% Ridefinisco le intestazioni per lo stile fancy (già impostato con \pagestyle{fancy})
\fancyhf{}
\fancyhead[LE,RO]{\thepage}
\fancyhead[LO]{\scshape\nouppercase{\rightmark}}
\fancyhead[RE]{\scshape\nouppercase{\leftmark}}
% Con le due righe seguenti modifico solamente lo spazio: ->\ \,<- anziché \qquad
...
% affinché la bibliografia sia una section della prefazione e non un capitolo a parte
\renewcommand{\bibsection}{\section*{\bibname}}
% per backref
\renewcommand{\backref}[1]{}
% per avere in backref i riferimenti in italiano anziché in inglese
...
\begin{description}
\item[Antonio Macrì] Ha scritto i capitoli~\ref{cha:segnali}, \ref{cha:segnali-periodici}, \ref{cha:segnali-aperiodici}, \ref{cha:sistemi-lineari}, \ref{cha:sistemi-non-lineari}, \ref{cha:segnali-campionati}, \ref{cha:processi-stocastici}.
